...
import { DescendantProvider } from '@mui/lab/TreeView/descendants';
import { getTreeViewUtilityClass } from '@mui/lab/TreeView/treeViewClasses';
...
const KeylessTreeView = React.forwardRef(function KeylessTreeView(inProps, ref) {
...
KeylessTreeView.propTypes /* remove-proptypes */ = {
  // ----------------------------- Warning --------------------------------
...
export default KeylessTreeView;