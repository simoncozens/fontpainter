// Copied from my COLRv1 branch of fontkit so we can get at the Paint table.
import * as r from 'restructure';
import { ItemVariationStore, DeltaSetIndexMap } from './variations';

export let F2DOT14 = new r.Fixed(16, 'BE', 14);
export let Fixed = new r.Fixed(32, 'BE', 16);
export let FWORD = r.int16;
export let UFWORD = r.uint16;

// COLRv0

export let LayerRecord = new r.Struct({
...
export let BaseGlyphRecord = new r.Struct({
...
export let Affine2x3 = new r.Struct({
...
export let VarAffine2x3 = new r.Struct({
  xx: Fixed,                  // x-component of transformed x-basis vector.
  yx: Fixed,                  // y-component of transformed x-basis vector.
  xy: Fixed,                  // x-component of transformed y-basis vector.
  yy: Fixed,                  // y-component of transformed y-basis vector.
...
export let ColorLine = new r.Struct({
...
export let VarColorLine = new r.Struct({
  extend: r.uint8,            // An Extend enum value
  numStops: r.uint16,         // Number of ColorStop records.
...
export var Paint = new r.VersionedStruct(r.uint8, {});
...
export var LayerList = new r.Struct({
  numLayers: r.uint32,
...
export var ClipBox = new r.VersionedStruct(r.uint8, {
  header: {
    xMin: r.int16,
    yMin: r.int16,
    xMax: r.int16,
