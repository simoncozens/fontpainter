function hbjs(instance) {
  ...
  **/
  ...
  function buildFace() {
    var ptr = exports.hb_face_builder_create();
    return {
      ptr: ptr,
      addTable: function(tag, data) {
        exports.hb_face_builder_add_table(ptr, hb_tag(tag), createBlob(data).ptr);
      },
      save: function() {
        // Repack
        ...
        var length = exports.hb_blob_get_length(blob);
        if (!length) { return; }
        var font_string = heapu8.subarray(offset, offset + exports.hb_blob_get_length(blob))
        return font_string;
      }
